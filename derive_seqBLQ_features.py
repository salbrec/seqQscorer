...
"python derive_seqBLQ_features.py --help" will display a formatted help text on
...
# check if bed file was created successfully
n_mapped_Bowtie2 = stats_Bowtie2['1time'] + stats_Bowtie2['multi']
mapped_reads_in_BED = utils.get_file_length(bed_file)
if mapped_reads_in_BED != n_mapped_Bowtie2:
	print('The number of mapped reads in the BED file does not match the Bowtie2 mapping statistics.')
	print('Mapped reads in Bowtie2 stats:', n_mapped_Bowtie2)
	print('Mapped reads in BED file:', mapped_reads_in_BED)
	exit(-1)
